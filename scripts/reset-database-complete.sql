-- =====================================================
-- RESET COMPLETO DE BASE DE DATOS RSL SYSTEM
-- =====================================================
-- ⚠️ ADVERTENCIA: ESTO BORRARÁ TODOS LOS DATOS
-- =====================================================

-- =====================================================
-- PARTE 1: LIMPIAR TODO
-- =====================================================
...
DROP TABLE IF EXISTS rqs_entries CASCADE;
DROP TABLE IF EXISTS prisma_items CASCADE;
...
DROP FUNCTION IF EXISTS update_rqs_updated_at() CASCADE;
