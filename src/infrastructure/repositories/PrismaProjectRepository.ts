...
import { Project as DomainProject } from "@domain/entities"
import { 
  IProjectRepository, 
  CreateProjectData, 
  UpdateProjectData 
...
export class PrismaProjectRepository implements IProjectRepository {
  ...
  private toDomain(prismaProject: any): DomainProject {
    return new DomainProject({
      ...
      collaborators: prismaProject.members?.map((m: any) => m.user?.fullName || m.userId) || [],
      references: {
