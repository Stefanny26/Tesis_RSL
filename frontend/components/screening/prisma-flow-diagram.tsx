        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6 text-center">
              ...
              <div className="bg-white rounded-lg p-4 inline-block">
                <p className="text-3xl font-bold text-blue-900">{stats.identified}</p>
          ...
          <div className="relative">
            <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-4 text-center">
              <div className="flex items-center justify-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-green-900">{stats.afterDedup}</p>
            ...
            <div className="bg-purple-50 border-2 border-purple-300 rounded-lg p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 text-center border border-purple-200">
                  <p className="text-2xl font-bold text-purple-900">{stats.screenedTitleAbstract}</p>
                ...
                <div className="bg-red-50 rounded-lg p-4 text-center border border-red-300">
                  <p className="text-2xl font-bold text-red-900">{stats.excludedTitleAbstract}</p>
                  <p className="text-sm text-red-700">❌ Excluidas</p>
                </div>
              </div>
            </div>
            <div className="flex justify-center my-2">
            ...
            <div className="bg-orange-50 border-2 border-orange-300 rounded-lg p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 text-center border border-orange-200">
                  <p className="text-2xl font-bold text-orange-900">{stats.fullTextAssessed}</p>
                  <p className="text-sm text-muted-foreground">Evaluadas</p>
                </div>
                <div className="bg-red-50 rounded-lg p-4 text-center border border-red-300">
                  <p className="text-2xl font-bold text-red-900">{stats.excludedFullText}</p>
                  <p className="text-sm text-red-700">❌ Excluidas</p>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="bg-green-50 border-2 border-green-400 rounded-lg p-6 text-center">
              ...
              <div className="bg-white rounded-lg p-6 inline-block border-2 border-green-400">
                <p className="text-4xl font-bold text-green-900 mb-2">{stats.includedFinal}</p>
